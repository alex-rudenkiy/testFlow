...
args = {
    "project_id": "untitled888-1010205154",
}

dag = DAG(
    "untitled888-1010205154",
    default_args=args,
...
op_31232e44_7f56_4f0e_90b6_46694388cdfc = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "untitled888-{{ ts_nodash }}",
    },
    volumes=[],
    secrets=[],
    annotations={},

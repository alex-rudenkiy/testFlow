...
args = {
    "project_id": "untitled777-1010204911",
}

dag = DAG(
    "untitled777-1010204911",
    default_args=args,
...
op_31232e44_7f56_4f0e_90b6_46694388cdfc = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "untitled777-{{ ts_nodash }}",
    },
    volumes=[],
    secrets=[],
    volume_mounts=[],

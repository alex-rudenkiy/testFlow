...
args = {
    "project_id": "untitled33-1010204001",
}

dag = DAG(
    "untitled33-1010204001",
    default_args=args,
...
op_31232e44_7f56_4f0e_90b6_46694388cdfc = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "untitled33-{{ ts_nodash }}",
    },
    volumes=[],
    secrets=[],
    annotations={},

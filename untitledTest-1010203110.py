...
args = {
    "project_id": "untitledTest-1010203110",
}

dag = DAG(
    "untitledTest-1010203110",
    default_args=args,
...
op_31232e44_7f56_4f0e_90b6_46694388cdfc = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "untitledTest-{{ ts_nodash }}",
    },
    volumes=[],
    secrets=[],
    annotations={},

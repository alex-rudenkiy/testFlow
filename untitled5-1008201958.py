...
args = {
    "project_id": "untitled5-1008201958",
}

dag = DAG(
    "untitled5-1008201958",
    default_args=args,
...
op_d438c847_d2f7_4a80_839a_e3da30da083a = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "untitled5-{{ ts_nodash }}",
    },
    volumes=[],
    volume_mounts=[],
    secrets=[],
